        ...
        return (
            <div className="login">
                ...
                <TextInput type="email" placeholder="Email (someone@example.com)" value={this.state.email}
                    onChange={e => {this.setState({ email: e }); this.displayName(e)}} onEnter={() => this.onClick()} autofocus={true} />
                <TextInput value={this.state.password} onChange={e => this.setState({ password: e })} onEnter={() => this.onClick()} type="password" placeholder="Password" />
                {this.state.register &&
